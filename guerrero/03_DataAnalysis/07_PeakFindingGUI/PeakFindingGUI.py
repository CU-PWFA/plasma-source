...
def LoadRawSignal(event):
    ...
    MediaPath= os.path.expanduser('~/Desktop/Guerrero DAQ local copy/DAQ_Data/mnt/md0/DAQ/IMAGE/year_2021/month_10/day_29/')
...
def ReMatch(event):
    ...
    ResultDir= os.path.expanduser('~/Desktop/Guerrero DAQ local copy/plasma-source-master/lee/03_DataAnalysis/05_ParameterScan/01_Ar/01_PressureScan/02_MultishotsAvgResults/')
    seed= y1
