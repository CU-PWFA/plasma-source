...
#define result path
ResultPath= os.path.expanduser('~/Desktop/Guerrero DAQ local copy/plasma-source-master/lee/03_DataAnalysis/05_ParameterScan/01_Ar/01_PressureScan/04_Results')
