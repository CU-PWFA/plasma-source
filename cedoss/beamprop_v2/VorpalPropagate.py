...
filename = '/home/chris/Desktop/SimulationRepo/TestCases/3D/200um/ThinPlasmaLens3D_Single_ElectronBeam_10.h5'
...
z_arr = np.linspace(0, 0.01, 1000 + 1)
...
PProp.PlotSigmar(beam,z_fine,m)
