...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 24 10:04:27 2022
...
Made this to look at different slices other than the center
...
for i in range(len(vecarr)):
    ...
    #Sep Grad
    radius = 41.97e-6 #m #41.97e-6 for -100
    radmax = 76.44e-6
    ...
    facB = 2.482
    delta = 0.134
    rpl = radmax*np.sqrt((n_cent-facA*radmax*slope)/n_cent) #sign flip b/c slope is wack
    rmn = radmax*np.sqrt((n_cent+facA*radmax*slope)/n_cent)
