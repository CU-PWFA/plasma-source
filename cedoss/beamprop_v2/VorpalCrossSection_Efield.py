...
x, y, evx, evy, eYZ = plot.wake_cross_section_efield(params)

pi = np.pi
e = const.physical_constants['elementary charge'][0]
#radius = 29.17866591e-6 #m
radius = 29.32077702e-6 #m
ybar = 0.5137*1e-6
#ybar = 0#2.25574658*1e-6
n_cent = 3e17*100**3 #m-3
slope = -2*6e18*100**4 #m-4
...
if vector != 0:
    plt.plot(y,e_v_y_theory,label="Theory")
    plt.plot(y,e_v_y_theory*0.6,label="Theory*0.6")
