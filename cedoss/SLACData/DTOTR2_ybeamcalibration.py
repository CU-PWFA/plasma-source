...
z_arr = np.linspace(func_start, func_end, n_step)
...
plt.errorbar(z_arr,ybeam_ave,ybeam_std,label="0 psi dataset")
plt.plot(z_arr,z_arr*lfit[0]+lfit[1],ls='--',label="linear fit")
plt.xlabel("z (m)")
plt.ylabel("Energy Centroid on Screen (mm)")
plt.legend(); plt.grid(); plt.show()

print("Linear Fit:")
print(" ybeam = z_arr *",lfit[0]," + ",lfit[1])