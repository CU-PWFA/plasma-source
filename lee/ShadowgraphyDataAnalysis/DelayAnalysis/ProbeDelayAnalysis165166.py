...
BG= np.array(Image.open('2109170166/19423598_2109170166_0000.tiff'))
...
Data= np.array(Image.open('2109170165/19423598_2109170165_0000.tiff'))
...
#%%
SignalRangeX= [215, 465]
SignalRangeY= [200, 375]
