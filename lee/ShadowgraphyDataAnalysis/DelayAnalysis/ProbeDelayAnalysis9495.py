...
BG= np.array(Image.open('2109170095/19423598_2109170095_0000.tiff'))
...
Data= np.array(Image.open('2109170094/19423598_2109170094_0000.tiff'))
...
#%%
SignalRangeX= [175, 425]
SignalRangeY= [260, 340]
