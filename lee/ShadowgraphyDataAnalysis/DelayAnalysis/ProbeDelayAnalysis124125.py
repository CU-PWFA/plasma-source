...
BG= np.array(Image.open('2109170124/19423598_2109170124_0000.tiff'))
...
Data= np.array(Image.open('2109170125/19423598_2109170125_0000.tiff'))
...
#%%
SignalRangeX= [230, 480]
SignalRangeY= [240, 430]
