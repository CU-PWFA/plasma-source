...
BG= np.array(Image.open('2109170100/19423598_2109170100_0000.tiff'))
...
Data= np.array(Image.open('2109170101/19423598_2109170101_0000.tiff'))
...
#%%
SignalRangeX= [205, 455]
SignalRangeY= [270, 375]
