...
BG= np.array(Image.open('2109170140/19423598_2109170140_0000.tiff'))
...
Data= np.array(Image.open('2109170141/19423598_2109170141_0000.tiff'))
...
#%%
SignalRangeX= [165, 415]
SignalRangeY= [210, 420]
