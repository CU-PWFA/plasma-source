...
beamParams = {
    ...
    'waist' :  2.00228e3,#The spot size of the flattop region.
    'z0' : 0.0,
    'order' : 3,
...
#phase= np.unwrap(-5.89e6-11.921*rho**2)
phase= -5.89e6-11.921*rho**2*1e-12 #The number is from Gaussian beam hand-calculation
#%%
interactions.beam_phase(beam, phase)
#%%
beam.propagate(0.75e6, 1)
#%%
...
#plt.figure(4)
#%%
beam.plot_intensity_at(512)
#%%
beam.propagate(15e6, 1)
#%%
