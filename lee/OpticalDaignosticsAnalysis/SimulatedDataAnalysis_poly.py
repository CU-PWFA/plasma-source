...
for den in Density:
    for pw in PWidth:
        try:
            ...
            AGSlopePara= np.load('p_slope_poly.npy')
            #Offset= AGOffsetPara[0]*Den+AGOffsetPara[1]
            AGOffsetPara= np.load('p_offset_poly.npy')
            ...
            intSlp= AGSlopePara[0]+AGSlopePara[1]*intden+AGSlopePara[2]*intden**2+AGSlopePara[3]*intden**3
            intOfst= AGOffsetPara[0]+AGOffsetPara[1]*intden+AGOffsetPara[2]*intden**2+AGOffsetPara[3]*intden**3
