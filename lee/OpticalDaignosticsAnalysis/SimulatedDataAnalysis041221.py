    ...
    for pw in PWidth:
        try:
            ...
            ShaData= np.load('/media/valentinalee/TRANSCEND/ShadowgraphyResults/FFResults2/PW'\
                             +str(pw)+'_GP5_n'+str(int(den*10))+'.npy')
            #pixel
