...
NewXMatrix[:, 0]= XMatrix[:, 3]/np.amax(XMatrix[:, 3]) #1
NewXMatrix[:, 2]= XMatrix[:, 3]*XMatrix[:, 5]/np.amax(XMatrix[:, 3]*XMatrix[:, 5]) #2

#%%
NewXMatrix= np.zeros((XMatrix.shape[0],  14))
NewXMatrix[:, 0]= XMatrix[:, 3]/np.amax(XMatrix[:, 3]) #7
NewXMatrix[:, 1]= XMatrix[:, 4]/np.amax(XMatrix[:, 4]) #3
NewXMatrix[:, 2]= XMatrix[:, 5]/np.amax(XMatrix[:, 5]) #4
NewXMatrix[:, 3]= XMatrix[:, 2]*XMatrix[:, 3]/np.amax(XMatrix[:, 2]*XMatrix[:, 3]) #10
NewXMatrix[:, 4]= XMatrix[:, 2]*XMatrix[:, 5]/np.amax(XMatrix[:, 2]*XMatrix[:, 5]) #6
NewXMatrix[:, 5]= XMatrix[:, 3]*XMatrix[:, 4]/np.amax(XMatrix[:, 3]*XMatrix[:, 4]) #8
NewXMatrix[:, 6]= XMatrix[:, 3]*XMatrix[:, 5]/np.amax(XMatrix[:, 3]*XMatrix[:, 5]) #9
NewXMatrix[:, 7]= XMatrix[:, 4]*XMatrix[:, 5]/np.amax(XMatrix[:, 4]*XMatrix[:, 5]) #2
NewXMatrix[:, 8]= XMatrix[:, 4]**2/np.amax(XMatrix[:, 4]**2) #1
NewXMatrix[:, 9]= XMatrix[:, 5]**2/np.amax(XMatrix[:, 5]**2) #5
#%%neg
NewXMatrix= np.zeros((XMatrix.shape[0],  14))
NewXMatrix[:, 0]= XMatrix[:, 3]/np.amax(XMatrix[:, 3]) #7
NewXMatrix[:, 1]= XMatrix[:, 4]/np.amax(XMatrix[:, 4]) #3
NewXMatrix[:, 2]= XMatrix[:, 5]/np.amax(XMatrix[:, 5]) #4
NewXMatrix[:, 3]= XMatrix[:, 2]*XMatrix[:, 5]/np.amax(XMatrix[:, 2]*XMatrix[:, 5]) #6
NewXMatrix[:, 4]= XMatrix[:, 4]*XMatrix[:, 5]/np.amax(XMatrix[:, 4]*XMatrix[:, 5]) #2
NewXMatrix[:, 5]= XMatrix[:, 4]**2/np.amax(XMatrix[:, 4]**2) #1n
NewXMatrix[:, 6]= XMatrix[:, 5]**2/np.amax(XMatrix[:, 5]**2) #5
...
#%%
NewXMatrix= np.zeros((XMatrix.shape[0],  14))
NewXMatrix[:, 0]= XMatrix[:, 2]/np.amax(XMatrix[:, 2]) #5
NewXMatrix[:, 2]= XMatrix[:, 4]/np.amax(XMatrix[:, 4]) #1
NewXMatrix[:, 4]= XMatrix[:, 2]*XMatrix[:, 3]/np.amax(XMatrix[:, 2]*XMatrix[:, 3]) #2
NewXMatrix[:, 6]= XMatrix[:, 2]*XMatrix[:, 5]/np.amax(XMatrix[:, 2]*XMatrix[:, 5]) #8
NewXMatrix[:, 7]= XMatrix[:, 3]*XMatrix[:, 4]/np.amax(XMatrix[:, 3]*XMatrix[:, 4]) #6
NewXMatrix[:, 8]= XMatrix[:, 3]*XMatrix[:, 5]/np.amax(XMatrix[:, 3]*XMatrix[:, 5]) #7
NewXMatrix[:, 9]= XMatrix[:, 4]*XMatrix[:, 5]/np.amax(XMatrix[:, 4]*XMatrix[:, 5]) #4
NewXMatrix[:, 12]= XMatrix[:, 4]**2/np.amax(XMatrix[:, 4]**2) #3

#%%
NewXMatrix= np.zeros((XMatrix.shape[0],  14))
NewXMatrix[:, 0]= XMatrix[:, 2]/np.amax(XMatrix[:, 2]) #5
#NewXMatrix[:, 1]= XMatrix[:, 4]/np.amax(XMatrix[:, 4]) #1
NewXMatrix[:, 2]= XMatrix[:, 2]*XMatrix[:, 3]/np.amax(XMatrix[:, 2]*XMatrix[:, 3]) #2
NewXMatrix[:, 2]= XMatrix[:, 4]**2/np.amax(XMatrix[:, 4]**2) #3
NewXMatrix[:, 3]= XMatrix[:, 4]*XMatrix[:, 5]/np.amax(XMatrix[:, 4]*XMatrix[:, 5]) #4
#%%
w_reg= LinearRegression().fit(NewXMatrix, XMatrix[:, 1])
w_coef= w_reg.coef_
w_intercept= w_reg.intercept_
...
plt.colorbar()
plt.xscale('log')
plt.title('Density Error (10 terms)')
plt.xlabel('True Density (1e16 cm$^{-3}$)')
plt.ylabel('True Plasma Width ($\mu$m)')
#%%
