...
The spatial profile fitting equation is: 21.10191955e18*exp(-(r^2/(2*(30.77896877*1e-6)^2))^1.12552051)
The temporal profile fitting equation is: 21.10191955e18*exp((-1/2)*(t/12.8e-15)^2)
...
Ir= np.exp(-(r**2/(2*(30.77896877*1e-6)**2))**1.12552051)
