...
The spatial profile fitting equation is: 28.08738974e18*exp(-(r^2/(2*(30.88464733*1e-6)^2))^1.1988027)
The temporal profile fitting equation is: 28.08738974e18*exp((-1/2)*(t/12.8e-15)^2)
...
Ir= np.exp(-(r**2/(2*(30.88464733*1e-6)**2))**1.1988027)
