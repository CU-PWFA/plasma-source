...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 30 10:16:05 2021
...
sim_length = 350e4#3e6 #80e4
#np.save(path+'sim_size.npy', [sim_start, sim_length])


X = 30e3
Nx = 2**11
beam0, pulseParams = design.propagate_to_start(r, E, sim_start, X, Nx, path, lam, tau, 20, [-1, 1], plot=False)
#%%
Nx = 2**10
Nz = 100
X =30e3
